...
// Shared presentational primitives for the professional space. Every /pro/* page
// composes these so the whole platform reads as one system (Linear/Stripe-style:
// crisp surfaces, restrained indigo accent, clear hierarchy, designed states).
// All are server-safe (no hooks) so they drop into server pages directly.
